...
function listClickCallback(action, index) {
  ...
  switch (action) {
    case "showList":
      listItemView();
      console.log("showList callback for index:", activeList);
      break;
    case "editList":
      console.log("editList callback for index:", activeList);
      break;
    case "deleteList":
      console.log("deleteList callback for index:", activeList);
      break;
    default:
